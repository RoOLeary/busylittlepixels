  ...
  return(
    <>
      <section className="bg-white mt-2 carouselLeft pb-2">
        ...
        <div className="mx-auto max-w-prose text-lg mb-4 pl-4 sm:pl-4">
          <h1 className="font-black tracking-tighter text-3xl md:text-[3.5rem] mb-2 md:mb-6 last:mb-0 uppercase">LET IT <span style={{"color":"red"}}>SLIDE...</span></h1>
