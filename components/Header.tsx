            ...
            <div className="mx-auto flex flex-wrap py-5 md:flex-row items-start justify-between">
                ...
                <nav className={`nav`}>
                    ...
                    <ul className={`nav__menu-list px-6 ${navActive ? "active" : ""}`}>
                        {isMobile ? 
                            <div className={'flex'}>
                                <input className={'mobileSearch'} type={'text'} name={'search'} placeholder={'Search...'} /><button className="btn inline-block px-6 py-2.5 bg-red-500 text-white font-medium text-xs leading-tight uppercase rounded-r rounded-l-none shadow-md hover:bg-red-400 hover:shadow-lg focus:bg-red-500  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-500 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
