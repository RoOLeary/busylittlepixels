                    ...
                    <div className="relative lg:-my-8">
                        ...
                        <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:h-full lg:p-0">
                            <div className="aspect-w-10 aspect-h-6 overflow-hidden rounded-xl shadow-xl sm:aspect-w-16 sm:aspect-h-7 lg:aspect-none lg:h-full">
                                <img className="object-cover lg:h-full lg:w-full" src={quoteImageUrl} alt="" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="mx-auto max-w-md px-6 sm:max-w-2xl lg:max-w-none lg:px-0 lg:py-20">
                            <blockquote>
                                <div>
                                    ...
                                    <p className="mt-6 text-2xl font-medium text-white">{quoteTitle}</p>
                                </div>
                                <footer className="mt-6">
                                    <p className="text-base font-medium text-white">{quoter}</p>
                                    <p className="text-base font-medium text-red-100">{company}</p>
                                </footer>
                            </blockquote>
                        </div>
                    </div>
