      ...
      <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8 mt-8">
                ...
                <div className="relative px-8">              
                  <blockquote className="mt-8">
                    <div className="relative text-lg font-medium text-white md:flex-grow">
                      ...
                      <p className="relative">Busy Little Pixels makes me more productive and gets the job done in a fraction of the time. I'm glad I found Busy Little Pixels.</p>
                    </div>
                    <footer className="mt-4">
                      <p className="text-base font-semibold text-rose-200">Hank Scorpio, CEO at Globex</p>
                    </footer>
                  </blockquote>
                </div>
              </div>
          ...
          <div className="relative mx-auto max-w-md px-6 pb-10 sm:mb-8 sm:max-w-3xl lg:px-0">
            <div className="pt-12 sm:pt-16 lg:pt-20">
              <h2 className="text-3xl font-black tracking-tight text-gray-900 sm:text-4xl">Specialising in: <br /> Technical Discovery. <br /><strong>Modern</strong>, scalable CMS, web and mobile applications.<br />Digital/Business strategy.</h2>
