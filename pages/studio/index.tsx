        ...
        <div className="title_container">
            <div className="grid grid-cols-1 justify-items-center gap-10 homeAdjust mb-6">
                <div className="mx-auto w-full text-start mt-4">
                    <h1 className="px-6 font-black text-4xl md:text-6xl mb-6 last:mb-0 uppercase">busy <span style={{ "color": "red" }}>little</span> pixels<span style={{ "color": "red" }}>.</span> <span style={{ "color": "red" }}>STUDIO</span></h1>
                    <h3 className="px-6 mt-6 text-2xl leading-8 text-gray-600 sm:text-left">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</h3>
                </div>
            </div>
        </div>
        <GalleryGrid />
          ...
          <main>
            <div className="relative px-6 lg:px-8">
              <div className="mx-auto max-w-3xl pt-20 pb-2 sm:pt-48 md:pb-20">
                <div>
                  <div>
                    <h1 className="text-4xl font-black tracking-tightest sm:text-center sm:text-6xl uppercase">Snappy <span style={{ "color": "red"}}>{router.query.category}</span><br />CTA Here</h1>
