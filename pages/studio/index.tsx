    ...
    return(
        ...
        <Layout>
            ...
            <Bounded collapsible={true} as="section" className="px-6 py-32 md:py-20 md:override">
                <h1 className="px-0 md:px-6 font-black text-4xl md:text-6xl mb-6 last:mb-0 text-left md:text-center">busy<span style={{ "color": "red" }}>little</span>pixels<span style={{ "color": "red", "fontStyle": "italic" }}>:</span><span style={{ "color": "red" }}>studio</span></h1>
