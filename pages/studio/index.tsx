    ...
    return(
        ...
        <Layout>
            {/* <div className="isolate bg-white">
                ...
                <main>
                    <div className="relative px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl pt-20 pb-2 sm:pt-48 md:pb-20">
                            <div>
                               
                                <div>
                                    <h1 className="text-4xl font-black tracking-tightest sm:text-center sm:text-6xl uppercase">busy <span style={{ "color": "red" }}>little</span> pixels<span style={{ "color": "red" }}>.</span><span style={{ "color": "red" }}>STUDIO</span></h1>
                                    <p className="mt-6 text-lg leading-8 text-gray-600 text-left md:text-center">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</p>
                                </div>
            ...
            <Bounded collapsible={true} as="section" className="px-6 py-32 md:py-20 md:override">
                <h1 className="px-6 font-black text-4xl md:text-6xl mb-6 last:mb-0 text-left md:text-center uppercase">busy <span style={{ "color": "red" }}>little</span> pixels<span style={{ "color": "red" }}>.</span><span style={{ "color": "red" }}>STUDIO</span></h1>
                <h3 className="px-6 mt-6 text-2xl leading-8 text-gray-600 text-left md:text-center">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat aliqua.</h3>
            </Bounded>
            <GalleryGrid />
