            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 mb-8">
              ...
              <div className="col-span-1">
                ...
                <h1 className="mb-2 text-4xl font-extrabold leading-tightest text-gray-800">
                  <Link href="/articles/tech/single" className="duration-300 transition ease-in-out  text-gray-900 hover:text-red-600 uppercase">Process Documents Using Artificial Intelligence For RPA Bots</Link>
                </h1>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            ...
            <div className="col-span-1 md:col-span-3">
              ...
              <p className="mb-3 text-sm font-normal text-gray-500 allArticles_excerpt">
                ...
                javascript module that you can easily use in any other projectsss.
              </p>
              <a href="#" className="hidden md:visible btn btn-light btn-sm">Read More</a>
            </div>
